...
/* Creation des parts */
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('body-2045-AA', 'Body', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('battery-2045-AA', 'Baterry', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 100, 50, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('hemlet-2045-AA', 'hemlet', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, 1, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('brain-2045-AA', 'Brain', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, 1, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('right_arm-2045-AA', 'Arm', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 0, 1, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('left_arm-2045-AA', 'Arm', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, 0, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('right_leg-2045-AA', 'Leg', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 0, 1, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('left_leg-2045-AA', 'Leg', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, 0, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('right_arm-2045-AB', 'Arm', 'right_arm-2045-AB.png', 'red', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 0, 1, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('left_arm-2045-AB', 'Arm','right_arm-2045-AB.png', 'red', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, 0, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('right_leg-2045-AB', 'Leg','right_arm-2045-AB.png', 'red', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 0, 1, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
INSERT INTO set_mind.parts (name, type, visual, color, special_ability, strenght, speed, capacity, setmind, `left`, `right`, bottom, top, center, grade, date_creation, range_id) VALUES ('left_leg-2045-AB', 'Leg', 'right_arm-2045-AB.png', 'red', DEFAULT, DEFAULT, DEFAULT, DEFAULT, DEFAULT, 1, 0, DEFAULT, 0, 0, DEFAULT, DEFAULT, 1);
