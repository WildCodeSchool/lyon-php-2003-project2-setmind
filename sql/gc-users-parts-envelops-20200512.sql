...
CREATE TABLE `user` (
  ...
  `profil_id` int(11) DEFAULT NULL,
  `date_creation` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `parts_id_body` int(11) DEFAULT '76',
  `parts_id_battery` int(11) DEFAULT '76',
  `parts_id_brain` int(11) DEFAULT '76',
  `parts_id_hemlet` int(11) DEFAULT '76',
  `parts_id_left_arm` int(11) DEFAULT '76',
  `parts_id_right_arm` int(11) DEFAULT '76',
  `parts_id_left_leg` int(11) DEFAULT '76',
  `parts_id_right_leg` int(11) DEFAULT '76',
  `envelop_id` int(11) DEFAULT '19',
  ...
  KEY `user_ibfk_1` (`profil_id`),
  KEY `user_ibfk_10` (`envelop_id`),
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`profil_id`) REFERENCES `profil` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `user_ibfk_10` FOREIGN KEY (`envelop_id`) REFERENCES `envelop` (`id`),
...
INSERT INTO `user` (`id`, `first_name`, `last_name`, `email`, `pseudo`, `password`, `final_score`, `answer_id`, `profil_id`, `date_creation`, `parts_id_body`, `parts_id_battery`, `parts_id_brain`, `parts_id_hemlet`, `parts_id_left_arm`, `parts_id_right_arm`, `parts_id_left_leg`, `parts_id_right_leg`, `envelop_id`, `administrator`) VALUES (8,'Guille','WildMind','gc@setmind.fr','R.Guille Olivaw ','$2y$10$gLq1UYqIz6N36eHSDe2lKesKRKD/FytQ9QI0yFmweQEbNDfYrLoFS',NULL,NULL,NULL,'2020-05-08 20:24:19',76,77,83,76,103,9,11,12,18,1),(10,'WildMind','Ben','bm@setmind.fr',NULL,'$2y$10$SXTZAwr47OUu.mO9sBFcwuRFOKENJMiiyERdsUi2J6BsZDYhoIdoC',NULL,NULL,NULL,'2020-05-12 17:51:22',76,76,76,76,76,76,76,76,19,1),(12,'WildMind','Lisa','lt@setmind.fr',NULL,'$2y$10$0/kEVUPVq/XCGaErZvd9g.gEWIzclRFXUltwiQoQGww6/73RRCldC',NULL,NULL,NULL,'2020-05-12 17:58:44',76,76,76,76,76,76,76,76,19,1),(13,'WildMind','Benoit','bl@setmind.fr',NULL,'$2y$10$ndmfMTmOUSbNjWv8lNbwe.qNMfEc..5VPx6xFBXHu7epKxCjXm4E.',NULL,NULL,NULL,'2020-05-12 18:26:54',76,76,76,76,76,76,76,76,19,1),(15,'A','A','aa@setmind.fr',NULL,'$2y$10$blbFwr8Ml2vZpniuivOVZuKg1UTuxMqh3KlgNsHmRfYDrKxXaqMm.',NULL,NULL,NULL,'2020-05-12 18:43:15',76,76,76,76,76,76,76,76,19,0);
...
-- Dump completed on 2020-05-12 21:41:46
